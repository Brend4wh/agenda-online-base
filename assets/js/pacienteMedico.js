...
const routes = {
    registerPatient: `${API_URL}/pacientes`,
    registerDoctor: `${API_URL}/medicos`,
    loginPatient: `${API_URL}/pacientes/login`,
    loginDoctor: `${API_URL}/medicos/login`,
    scheduleAppointment: `${API_URL}/consultas`,
    getAppointments: `${API_URL}/consultas`
};
